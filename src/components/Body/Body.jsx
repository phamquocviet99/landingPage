...
import anh5 from "../../_global/assets/landingPageAssets/anh5.png";
...
export default function Body() {
  ...
  return (
    <div className="">
      <section className=" block lg:flex justify-end items-center gap-x-20 py-40 px-10 lg:px-0 bg-[#FCFAF7]">
      ...
      <section className="bg-[#FCFAF7] py-20">
        <div className="w-full mx-auto container">
          <div className="grid grid-cols-2 items-center w-full">
            <div className="bg-white  rounded-tr-[70px] rounded-bl-[70px] min-w-[500px] max-w-[600px] z-10 p-10 text-blue-600 hover:text-white hover:bg-blue-700 duration-300">
              <div className="flex justify-between items-center">
                {" "}
                ...
                <img
                  className=" h-20 opacity-10 object-cover"
                  alt=""
                  src={giftBox}
                />
              </div>{" "}
            ...
            <div className="w-full flex justify-end">
              <img
                className="max-h-full object-contain w-[70%]"
                alt=""
                src={anh7}
              ></img>
            </div>
